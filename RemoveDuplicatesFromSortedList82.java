...
public class RemoveDuplicatesFromSortedList82 {
    ...
    public static void main(String[] args) {
        ...
        RemoveDuplicatesFromSortedList82.ListNode linkedList = new RemoveDuplicatesFromSortedList82.ListNode(
                1,
                new RemoveDuplicatesFromSortedList82.ListNode(1,
                        new RemoveDuplicatesFromSortedList82.ListNode(2)));
